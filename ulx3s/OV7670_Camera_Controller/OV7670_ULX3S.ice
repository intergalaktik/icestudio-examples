  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "e74bf62c-c84a-40f5-85be-4836f0470ed4",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "653a0a1d-34cb-4ec2-afee-c5af86d2fd07",
          "type": "basic.info",
          "data": {
            "info": "### The OV7670 camera is a 0.3 Megapixel camera(640x480 @ 30fps). Data pixels are stored to SDRAM and retrieved by the HDMI which will then be displayed on the monitor.  \n### * `btn3` - increase brightness\n### * `btn4` - decrease brightness\n### * `btn6` - increase contrast\n### * `btn5` - decrease contrast",
            "readonly": true
          },
          "position": {
            "x": 1144,
